...
public class WhiteSpaceUtil {
    ...
    public enum SpecHtmlCharacterEnum {
        ...
        public static String spaceAppearanceRegexStr() {
            ...
            Arrays.stream(SpecHtmlCharacterEnum.values()).filter(i -> "space".equals(i.getAppearance())).forEach(
                i -> stringBuilder.append(i.getUnicodeRegex()));
        ...
        public static String emptyAppearanceRegexStr() {
            StringBuilder stringBuilder = new StringBuilder();
            Arrays.stream(SpecHtmlCharacterEnum.values()).filter(i -> "empty".equals(i.getAppearance())).forEach(
                i -> stringBuilder.append(i.getUnicodeRegex()));
            return stringBuilder.toString();
        }
    }
